...
class ExtendedregViewExport_ipaddr extends JViewLegacy {
	
	function display($tpl = null) {
		$model = $this->getModel();
		$items = $model->getUsersAndIPaddresses();
		...
		header("Content-Disposition: attachment; filename=users-IP-address-stats-" . date('d-m-Y-H-i') . ".csv");
