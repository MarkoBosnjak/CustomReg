...
class ExtendedregViewAddonedit extends JViewLegacy {
	...
	function display($tpl = null) {
		...
		$this->assignRef('lib', $lib);
		
		// Icons and titles in Toolbar
		$_title = JText::sprintf('COM_EXTENDEDREG_ADDONS_EDIT', $addon->name);
		...
		JToolBarHelper::custom('addons.save', 'save.png', 'save.png', JText::_('COM_EXTENDEDREG_SAVE'), false, false);
		JToolBarHelper::custom('addons.apply', 'apply.png', 'apply.png', JText::_('COM_EXTENDEDREG_APPLY'), false, false);
