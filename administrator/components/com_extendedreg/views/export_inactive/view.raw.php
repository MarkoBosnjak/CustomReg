...
class ExtendedregViewExport_inactive extends JViewLegacy {
	
	function display($tpl = null) {
		$model = $this->getModel();
		$items = $model->getInactiveUsers(true)->items;
		...
		header("Content-Disposition: attachment; filename=inactive-users-stats-" . date('d-m-Y-H-i') . ".csv");
