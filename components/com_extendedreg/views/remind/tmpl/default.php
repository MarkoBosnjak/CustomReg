...
<?php endif;  ?>
<?php if (trim($this->conf->html_before_remind)) : ?><div class="clrboth fltnone"><?php echo $this->conf->html_before_remind; ?></div><?php endif; ?>
...
<form action="<?php echo JRoute::_('index.php?option=com_extendedreg', false);?>" method="post" name="erRemindForm" id="erRemindForm" target="_top" class="er-form">
	...
	<input type="hidden" name="task" value="users.do_remind" />
...
<?php if (trim($this->conf->html_after_remind)) : ?><div class="clrboth fltnone"><?php echo $this->conf->html_after_remind; ?></div><?php endif; ?>
